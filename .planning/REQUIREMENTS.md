...
- [x] **HOME-02**: Server list displays as vertical cards with map background (fixed CS2 map thumbnails) and server data on top
- [x] **HOME-03**: User can toggle server list display between grid and table style
- [x] **HOME-04**: User can open a modal showing players on the server by clicking a server card
...
- [ ] **VIP-03**: User can purchase VIP directly on site via PayTR integration (callback 04-01; get-token/iframe 04-03)
...
| VIP-03 | Phase 4 | In progress (04-01 callback done) |
