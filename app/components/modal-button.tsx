...
export function ModalButton({
  ...
  return (
    <button
      className={clsx([
        className,
        "font-display pointer-events-auto relative flex h-9 cursor-default items-center rounded-xs px-3 font-bold uppercase font-stretch-[62.5%] drop-shadow-lg transition",
        variant === "primary" &&
