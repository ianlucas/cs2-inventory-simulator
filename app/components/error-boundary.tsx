      ...
      <body className="flex h-screen w-screen items-center justify-center bg-blue-500 font-mono text-white">
        <div className="lg:w-[1024px]">
          ...
          {error?.stack !== undefined && (
            <pre className="relative mt-4 max-h-[128px] overflow-hidden text-sm text-ellipsis after:pointer-events-none after:absolute after:top-0 after:left-0 after:block after:size-full  after:bg-linear-to-b after:from-transparent after:to-blue-500 after:content-['']">
              {error.stack}
            </pre>
          )}
        </div>
