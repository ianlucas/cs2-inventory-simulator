  ...
  return (
    ...
    >
      ...
      <label className={clsx("relative inline-flex items-center", className)}>
        ...
        <div
          className={clsx(
            "peer h-5 w-9 rounded-full bg-neutral-950/40 peer-checked:bg-blue-500/50 peer-focus:outline-hidden after:absolute after:top-[2px] after:left-[2px] after:h-4 after:w-4 after:scale-90 after:rounded-full after:border after:border-gray-300 after:bg-white after:transition-all after:content-[''] peer-checked:after:translate-x-full peer-checked:after:border-white",
            !props.disabled && "group-hover:after:scale-100"
          )}
        ></div>
      </label>
    </div>
