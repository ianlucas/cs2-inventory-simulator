...
export function Header() {
  ...
  return (
    <div
      className={clsx(
        "sticky left-0 top-0 z-20 w-full backdrop-blur transition-all before:absolute before:inset-0 before:-z-10 before:bg-gradient-to-b before:from-neutral-800/60 before:to-transparent before:transition-all before:content-['']",
