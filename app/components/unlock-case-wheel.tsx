...
export function UnlockCaseWheel({
  ...
  return (
    ...
    >
      ...
      >
        <div className="blur-0.5 absolute top-0 left-0 flex size-full items-center justify-center mask-[radial-gradient(circle_closest-side,#fff0_246px,#000_246px)] opacity-90">
