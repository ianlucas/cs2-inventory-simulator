...
export function UnlockCaseWheel({
  ...
  return (
    ...
    >
      ...
      >
        <div className="absolute top-0 left-0 flex h-full w-full items-center justify-center mask-[radial-gradient(circle_closest-side,#fff0_246px,#000_246px)] opacity-90 blur-[2px]">
