...
export const brazilian = {
  ...
  ItemWeaponRarityDefault: "Padrão",
  ItemWeaponRarityCommon: "Nível Consumidor",
  ItemWeaponRarityUncommon: "Nível Industrial",
  ItemWeaponRarityRare: "Nível Militar",
  ItemWeaponRarityMythical: "Restrito",
  ItemWeaponRarityLegendary: "Secreto",
  ItemWeaponRarityAncient: "Oculto",
  ItemWeaponRarityImmortal: "Contrabandeado",
  ItemRarityDefault: "Padrão",
  ItemRarityCommon: "Nível Básico",
  ItemRarityUncommon: "Nível Moderado",
  ItemRarityRare: "Alta Qualidade",
  ItemRarityMythical: "Notável",
  ItemRarityLegendary: "Exótico",
  ItemRarityAncient: "Extraordinário",
  ItemRarityImmortal: "Contrabandeado",
  ItemRarityNamePistol: "Pistola",
  ItemRarityNameSniperRifle: "Rifle de Precisão",
  ItemRarityNameRifle: "Rifle",
  ItemRarityNameSMG: "Submetralhadora",
  ItemRarityNameMachinegun: "Metralhadora",
  ItemRarityNameShotgun: "Escopeta",
  ItemRarityNameEquipment: "Equipamento",
  ItemRarityNameContract: "Contrato",
  ItemRarityNameTool: "Ferramenta",
  ItemRarityNameKnife: "Faca",
  ItemRarityNameGloves: "Luvas",
  ItemRarityNameSticker: "Adesivo",
  ItemRarityNameAgent: "Agente",
  ItemRarityNamePatch: "Emblema",
  ItemRarityNameMusicKit: "Trilha Sonora",
  ItemRarityNameGraffiti: "Grafite",
  ItemRarityNameCollectible: "Colecionável",
  ItemRarityNameContainer: "Recipiente",
  ItemRarityNameKey: "Chave",
