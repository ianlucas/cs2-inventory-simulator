...
import { getUserLanguagePreference, setUserLanguagePreference } from "~/models/user-preferences.server";
...
export async function action({ request }: ActionFunctionArgs) {
  ...
  const { language } = z.object({
    language: z.string().refine(language =>
      getAllowedLanguages().includes(language)
    )
