...
const STRINGS_FROM_GAME: Record<string, string | string[] | {
  ...
  ApplyStickerConfirmPosition: "SFUI_InvUse_Confirm_Sticker_slot",
  ApplyStickerHintMoveSticker: "popup_control_tooltip_move_sticker",
  ApplyStickerHintPanCamera: "laptop_pan_tooltip",
  ApplyStickerHintRotateSticker: "popup_control_tooltip_rotate_sticker",
  ...
  CaseContainsOne: "Econ_Revolving_Loot_List_Single",
  CaseInspectAll: "popup_inv_lootlist_inspect_all",
  ...
  EditorKeychains: "inv_nav_keychain",
  EditorKeychainX: "Workshop_Preview_X_Offset",
  EditorKeychainY: "Workshop_Preview_Y_Offset",
  EditorNametag: "ToolType_name",
  EditorPatches: "inv_nav_patches",
  EditorPattern: "Workshop_Preview_Pattern",
  ...
  RemovePatchClose: "GameUI_Close",
  RemovePatchRemove: "SFUI_InvContextMenu_can_stick_Wear_full_patch",
  RemovePatchRemoveHint: { token: "SFUI_Patch_Remove_Desc_Tooltip", transform: (value) => value.replace(/<\/?b>/g, '').replace(/<br\s*\/?>/g, '\n').trim() },
  RemovePatchUse: "SFUI_Patch_Remove",
  RemovePatchUseOn: { token: "popup_can_stick_scrape_full_patch", transform: (value) => replace(value, /<b>\s?\{s:tool_target_name\}<\/b>/, '') },
